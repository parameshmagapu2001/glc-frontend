...
import UserTableRow from '../regional-officers-table-row';
// ----------------------------------------------------------------------

const TABLE_HEAD = [
  { id: 'roleId', label: 'Ro Name ' },
...
export default function RegionalOfficersListView() {
  ...
  const handleViewRow = useCallback(
    (id: number) => {
      router.push(paths.rm.roles.regional_officer_view(id));
    },
    [router]
  );
