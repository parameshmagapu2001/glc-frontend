...
export default function IntelligenceOfficerNewEditForm({ currentUser, userId }: Props) {
      ...
      {!successFlag ?
        <Grid container spacing={2} sx={{ px: 10, py: 1, mb: 0 }}>
          ...
          <Grid xs={12} md={7} sx={{
            ...
            <img
              src="/assets/images/intelligenceOfficerForm.png"
              alt="IntelligenceOfficer"
              style={{
          ...
          <Grid xs={12} md={5} sx={{
            ...
            <Stack spacing={3}>
              ...
              <Typography variant="h6">Enter Intelligence Officer Details</Typography>
