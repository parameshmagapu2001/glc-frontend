...
export default function FieldOfficerNewEditForm({ currentUser, userId }: Props) {
      ...
      {!successFlag ?
        <Grid container spacing={2} sx={{ px: 10, py: 1, mb: 0 }}>
          ...
          <Grid xs={12} md={7} sx={{
            ...
            <img
              src="/assets/images/fieldOfficerForm.png"
              alt="FieldOfficer"
              style={{
          ...
          <Grid xs={12} md={5} sx={{
            ...
            <Stack spacing={3}>
              ...
              {officerDetails || intelligenceOfficer &&
                <Stack direction="row" spacing={2} >
                  <Image src="/assets/images/brakeWarning.png" alt="Arrow" height={20} width={20} />
                  <Typography variant="body2" sx={{ color: 'error.success' }}>{officerDetails}</Typography>
                </Stack>}
              ...
              {areaOfficerDetails && areaOfficerDetails !== 'NotFound' &&
                <Stack direction="row" spacing={2} >
                  ...
                  <Typography variant="body2" sx={{ color: 'error.main' }}>{areaOfficerDetails}</Typography>
                </Stack>}

              <Typography variant="h6">Enter Field Officer Details</Typography>
              ...
              <Stack direction="row" justifyContent="flex-start">
                <LoadingButton
                  ...
                  disabled={areaOfficerDetails !== 'NotFound' && !currentUser}
                  sx={{ borderRadius: 0.5 }}
                >
