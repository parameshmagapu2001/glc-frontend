...
} from 'src/app/admin/role-manager/components/table';
import Iconify from 'src/app/admin/role-manager/components/iconify';
import Scrollbar from 'src/app/admin/role-manager/components/scrollbar';
...
import AccountsView from 'src/app/admin/role-manager/sections/role-manager/role-area-regions/accounts-view';
...
export default function AgentsListView() {
  ...
  //   (id: number) => {
  //     router.push(paths.rm.product.details(id));
  //   },
  //   [router]
  // );
  ...
  const handleViewRow = (id: number) => {
    router.push(paths.rm.roles.agent_view(id));
  };
                        ...
                        {dataFiltered
                          ...
                          .map((row) => (
                            <AgentsTableRow
                              ...
                              onViewRow={() => handleViewRow(row.roleID)}
                            />
                          ))}
                      </>
                    )}
