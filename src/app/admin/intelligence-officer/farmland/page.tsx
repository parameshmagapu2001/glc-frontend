  ...
  const base = [
    {
      ...
      amount: "25 Lakhs",
      status: "Completed",
      published: "6th Oct - 12:53 PM",
      liveStatus: "Live in Website",
    },
    {
      agent: "Krishna",
    ...
    },
    {
      ...
      amount: "34 Lakhs",
      status: "Rejected",
      published: "4th Oct - 09:53 PM",
      liveStatus: "Rejected by AO",
    },
    {
      agent: "Paramesh",
...
/* ---------------- page component ---------------- */
export default function FarmlandIndex() {
        ...
        <Table>
          ...
          <TableBody>
              ...
              <TableRow key={i} hover>
                <TableCell>
                  <Stack direction="row" spacing={2} alignItems="center">
                    <Avatar src={r.avatar} sx={{ width: 44, height: 44 }}>{initials(r.agent)}</Avatar>
                ...
                <TableCell>
                  <Typography
                    ...
                    onClick={() => router.push(`/admin/intelligence-officer/farmland/${encodeURIComponent(r.id)}`)}
                  >
                    {r.id}
                  </Typography>
                </TableCell>
                ...
                <TableCell>
                  <Box
                    sx={{
                      ...
                      borderRadius: 6,
                      color: "white",
                      bgcolor: r.status === "Completed" ? "#10B981" : r.status === "Pending" ? "#F59E0B" : "#EF4444",
                    }}
                  >
                    {r.status}
                  </Box>
                ...
                <TableCell sx={{ color: "#374151" }}>{r.published}</TableCell>
                <TableCell sx={{ color: "#374151" }}>{r.liveStatus}</TableCell>

                <TableCell align="center">
                  <IconButton
                    onClick={() => router.push(`/admin/intelligence-officer/farmland/${encodeURIComponent(r.id)}`)}
                    sx={{ bgcolor: "#2B6CB0", color: "white", width: 36, height: 36, "&:hover": { bgcolor: "#244f85" } }}
            ...
            {currentRows.length === 0 && (
              <TableRow>
                <TableCell colSpan={10} sx={{ textAlign: "center", color: "gray", py: 6 }}>
                  No records found
                </TableCell>
              </TableRow>
            )}
