...
import FieldOfficerTableRow from '../field-officers-table-row';
// ----------------------------------------------------------------------

const TABLE_HEAD = [
  { id: 'roleId', label: 'Fo Name ' },
...
export default function FieldOfficersListView() {
  ...
  const handleViewRow = (id: number) => {
    router.push(paths.rm.roles.field_officer_view(id));
  };
