  ...
  return (
    <>
      <Stack
        overflow="hidden"
        minWidth="264px"
        sx={{ cursor: 'pointer', borderRadius: '16px', mr: 2 }}
        onClick={() => router.push(`/super-admin/top-performers/${item.userId}`)}
      >
        ...
        <Box>
          <Image
            src={item.profileImage ? item.profileImage : '/assets/images/regionalOfficerCreate.png'}
            width={264}
            height={154}
          />
        </Box>
