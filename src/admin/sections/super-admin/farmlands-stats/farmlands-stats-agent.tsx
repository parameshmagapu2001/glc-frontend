...
const agents: AgentsData[] = [
    {
      "agent": "Varma",
      "buyer_name": "Varma",
      "mail_id": "varma@gmail.com",
      "phone": "+91-9245279149",
      "query_date": "3rd Oct - 04:13 PM",
...
const FarmlandsStatsAgent = () => {
  ...
  const filteredData = agents.filter((row) =>
              ...
              borderTopRightRadius: 20, 
                ...
                {filteredData.slice((page - 1) * rowsPerPage, page * rowsPerPage).map((row,index) => (
                    <TableRow key={index} hover>
                      ...
                      <TableCell>{row.query_date}</TableCell>
...
export default FarmlandsStatsAgent;