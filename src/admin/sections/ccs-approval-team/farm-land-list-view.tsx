...
import { InputAdornment, Stack, TextField, Typography, SelectChangeEvent, Box, Select, MenuItem } from '@mui/material';
...
export default function FarmlandListView() {
  ...
  const filteredData = useMemo(() => {
    ...
    return arr;
  }, [tableData, query, selectedStatus, selectedState, selectedRegion, selectedArea, regions, areas]);
