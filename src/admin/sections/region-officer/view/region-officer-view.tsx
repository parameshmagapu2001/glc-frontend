...
import RegionOfficerWidgetSummary from './region-office-widget-summary';
import RegionOfficerPageView from './region-officer-page-view';
// ----------------------------------------------------------------------
...
export default function RegionOfficerView() {
        ...
        <Grid xs={12} md={12}>
          <Stack direction={{ xs: 'column', sm: 'row' }} spacing={3}>
            ...
            <RegionOfficerWidgetSummary
              ...
              onClick={() => router.push(`${paths.ro.allFarmlands}?status=approved`)}
            />
            <RegionOfficerWidgetSummary
              title="Pending Farmlands"
              total={farmlandAnalytics?.pendingFarmlands}
              src='/assets/images/ccsreject.png'
              onClick={() => router.push(`${paths.ro.allFarmlands}?status=pending`)}
            />
          </Stack>
        </Grid>
