...
import InprogressFarmLandTableRow from './inprogress-farm-land-table-row';
...
export default function InprogressFarmLandListView() {
    ...
    <Stack>
      ...
      {!farmlandsEmpty && totalCount > 4 &&
        <Typography
          ...
          color="#3C78B9"
          sx={{ cursor: 'pointer' }}
          onClick={() => router.push(paths.vo.all_inprogress_farmland)}
        >
          View More
        </Typography>}
    </Stack>
