...
import { Box, Container, Input, InputAdornment, Stack, TextField } from '@mui/material';
...
import DraftTableRow from '../draft-table-row';
...
export default function AllDraftListView() {
                    ...
                    {tableData
                      .map((row) => (
                        <DraftTableRow
                          key={row.farmlandId}
                          row={row}
                          onDeleteRow={() => handleDeleteRow(row.farmlandId)}
