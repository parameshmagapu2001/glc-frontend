...
import AllAlertsTableRow from '../all-alerts-table-row';
import CustomPagination from '../common-layout/pagination';
// ----------------------------------------------------------------------

const STATUS_OPTIONS = [
  { value: 'InLive', label: 'In Live' },
...
const TABLE_HEAD = [
  ...
  { id: 'farmlandId', label: 'Farmland Id' },
  { id: 'action', label: 'Action' },
];

export default function AllFarmlandAlertsListView() {
                  ...
                  <>
                    {tableData.map((row) => (
                      <AllAlertsTableRow
                        key={row.alertId}
                        row={row}
                        onDeleteRow={() => handleDeleteRow(row.alertId)}
                        onEditRow={() => handleEditRow(row.alertId)}
