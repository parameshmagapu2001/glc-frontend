...
function WestBoundariesForm({ farmlandId, documentIndex, documentDetails, onNext }: Props) {
  ...
  const onSave = async () => {
    ...
    if (boundaryType === '0') {
      enqueueSnackbar('Please select west boundaries', {
        variant: 'error',
      ...
      {activeView === 'file' &&
        ...
        >
          <Stack direction='row' justifyContent='space-between' width='100%'>
            ...
            <Box width="40%">
              <Typography fontWeight="subtitle1" sx={{ my: 2, fontWeight: 'bold' }}>West Boundaries:</Typography>

              <FormProvider {...methods}>
                <RHFSelect
                  name="eastBoundaries"
                  placeholder="Select West Boundaries"
                ...
                >
                  <MenuItem value="0">Select West Boundaries</MenuItem>
...
export default WestBoundariesForm;
