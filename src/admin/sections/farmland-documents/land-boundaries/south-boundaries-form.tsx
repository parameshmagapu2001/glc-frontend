...
function SouthBoundariesForm({ farmlandId, documentIndex, documentDetails, onNext }: Props) {
  ...
  const onSave = async () => {
    if (boundaryType === '0') {
      enqueueSnackbar('Please select south boundaries', {
        variant: 'error',
  ...
  return (
    <>
      ...
      {activeView === 'file' &&
        ...
        >
          <Box width="40%">
            <Typography fontWeight="subtitle1" sx={{ my: 2, fontWeight: 'bold' }}>South Boundaries:</Typography>

            <FormProvider {...methods}>
              <RHFSelect
                name="eastBoundaries"
                placeholder="Select South Boundaries"
              ...
              >
                <MenuItem value="0">Select South Boundaries</MenuItem>
...
export default SouthBoundariesForm;
