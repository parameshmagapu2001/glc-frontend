...
function EastBoundariesForm({ farmlandId, documentIndex, documentDetails, onNext }: Props) {
  ...
  const onSave = async () => {
    if (boundaryType === '0') {
      enqueueSnackbar('Please select east boundaries', {
        variant: 'error',
      ...
      {activeView === 'file' &&
        ...
        >
          <Stack direction='row' justifyContent='space-between' width='100%'>
            ...
            <Box width="40%">
              <Typography fontWeight="subtitle1" sx={{ my: 2, fontWeight: 'bold' }}>East Boundaries:</Typography>

              <FormProvider {...methods}>
                <RHFSelect
                  name="eastBoundaries"
                  placeholder="Select East Boundaries"
                ...
                >
                  <MenuItem value="0">Select East Boundaries</MenuItem>
...
export default EastBoundariesForm;
