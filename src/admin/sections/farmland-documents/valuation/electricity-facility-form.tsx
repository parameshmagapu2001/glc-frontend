...
function ElectricityFacilityForm({ farmlandId, documentIndex, documentDetails, onNext }: Props) {
  ...
  const onSave = async () => {
    if(!electricityFacility) {
      enqueueSnackbar('Please select the electricity facility', {
        variant: 'error',
      ...
      {activeView === 'file' &&
        ...
        >
          <Stack direction='row' justifyContent='space-between'>
            <Box width="40%">
              <Typography fontWeight="medium">Electricity Facility</Typography>
...
export default ElectricityFacilityForm;
