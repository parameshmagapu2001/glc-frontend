...
import { Box, Button, Card, Grid, Stack, TextareaAutosize, Typography } from '@mui/material';
import Timeline from '@mui/lab/Timeline';
import TimelineDot from '@mui/lab/TimelineDot';
import TimelineContent from '@mui/lab/TimelineContent';
import TimelineSeparator from '@mui/lab/TimelineSeparator';
import TimelineConnector from '@mui/lab/TimelineConnector';
import TimelineItem, { timelineItemClasses } from '@mui/lab/TimelineItem'; import Image from 'next/image';
...
function VillageMapNakshaForm({ farmlandId, documentIndex, documentDetails, onNext }: Props) {
...
export default VillageMapNakshaForm;
