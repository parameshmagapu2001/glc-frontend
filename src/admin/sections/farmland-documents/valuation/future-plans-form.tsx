...
function FuturePlansForm({ farmlandId, documentIndex, documentDetails, onNext }: Props) {
      ...
      {activeView === 'file' &&
        ...
        >
          <Stack direction='row' justifyContent='space-between' alignItems='center' width="100%">
            <Box width="50%">
              <Typography fontWeight="medium">Future Plans of Geographical Advantages</Typography>
              <TextareaAutosize
                style={{
                  width: '100%',
                  marginTop: '10px',
...
export default FuturePlansForm;
