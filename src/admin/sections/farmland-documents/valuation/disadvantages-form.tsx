...
function DisadvantagesForm({ farmlandId, documentIndex, documentDetails, onNext }: Props) {
    ...
    <>
      ...
      {activeView === 'file' &&
        ...
        >
          <Stack direction='row'>
            <Box width="50%">
              <Typography fontWeight="medium">Validating the Disadvantages near the land</Typography>
              <TextareaAutosize
                style={{
                  width: '100%',
                  marginTop: '10px',
...
export default DisadvantagesForm;
