...
function LegalDocForm({ farmlandId, documentIndex, documentDetails, onNext }: Props) {
  ...
  const renderButtons = () => {
    const { reviewStatus, approveAccess, documentStatus } = documentDetails;
    ...
    <>
      ...
      {activeView === 'file' &&
        <Stack
          ...
          px="20px"
          py="45px"
          minHeight={timelineViewStatus ? '68%' : '75%'}
